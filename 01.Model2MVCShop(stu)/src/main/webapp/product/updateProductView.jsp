...
function fncAddProduct(){
	...
	document.detailForm.action='/updateProduct.do?prodNo=<%= vo.getProdNo()%>&menu=ok';
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="prodDetail" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="10" minLength="6"value = "<%=vo.getProdDetail()%>"/>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="manuDate" readonly="readonly" class="ct_input_g"  
						style="width: 100px; height: 19px"	maxLength="10" minLength="6" value = "<%=vo.getManuDate()%>"/>
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="price" 	class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="10" value = "<%=vo.getPrice()%>">&nbsp;원
		</td>
	</tr>
